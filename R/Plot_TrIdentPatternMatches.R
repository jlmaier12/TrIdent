...
#' @examples
#' \dontrun{
#' pattern_matches <- Plot_TrIdentPatternMatches(VLP_fracreadcov, whole_commreadcov, TrIdent_results)
#' pattern_matches$NODE_1
#' }
Plot_TrIdentPatternMatches <- function(phageread_dataset, microbialread_dataset, transductionclassifications, cleanup=TRUE) {
