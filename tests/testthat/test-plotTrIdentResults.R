test_that("plotTrIdentResults", {
  ...
  temp_patternmatcher <- plotTrIdentResults(VLPpileup=VLPFractionSamplePileup, WCpileup=WholeCommunitySamplePileup, TrIdentResults=TrIdent_results, cleanup=TRUE)
