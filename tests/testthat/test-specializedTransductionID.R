test_that("specializedTransductionID", {
  ...
  TrIdent_results <- TrIdentClassifier(VLPpileup=VLPFractionSamplePileup,
                                       WCpileup=WholeCommunitySamplePileup)
  temp_Specialized_transduction <- specializedTransductionID(VLPpileup=VLPFractionSamplePileup,
  ...
  temp_Specialized_transduction_n62 <- specializedTransductionID(VLPpileup=VLPFractionSamplePileup,
                                                                 TrIdentResults=TrIdent_results,
