...
#' generated from BBMap's pileup.sh.
#' Report...
#'
#' @keywords internal
...
#' particle (VLP)-fraction. This dataset represents the VLP fraction and was
#' generated by purifying VLPs from a conventional mouse fecal homogenate using
#' CsCl density gradient ultracentrifugation. The VLP-fraction extracted DNA was
#' sequenced with Illumina (paired-end mode, 150 bp reads) The sequencing reads
#' were mapped to the associated whole-community assembly using BBMap. The
