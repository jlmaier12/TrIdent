...
#'
#' Spec_Transduction_NODE1 <- SpecializedTransduction_ID(VLP_fracreadcov, TrIdent_results, specificcontig="NODE_1", noreadcov=1000, spectranslength=4000)
#' }
 SpecializedTransduction_ID <- function(phageread_dataset, transductionclassification, specificcontig, noreadcov=500, spectranslength=2000, cleanup=TRUE){
