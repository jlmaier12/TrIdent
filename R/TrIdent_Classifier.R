...
#'}
  ...
  SM_classifications_summary <- pattern_matcher(phageread_dataset, microbial_readdataset, windowsize, minblocksize, maxblocksize)
  ...
  summary_table_almostfinal <- prophagelikeactivity_checker(summary_table_matchsize, prophage_classifications_list, phageread_dataset, microbial_readdataset, windowsize)
