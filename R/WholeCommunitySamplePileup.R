...
#' @format ## 'WholeCommunitySamplePileup' A data frame with 10,805 rows and 4
#'   columns:
#' \describe{
...
#'  the start of each new contig.}
#' }
#' @details This dataset represents one half of a complete transductomics
...
#' whole-community fraction and was generated from a conventional mouse fecal
