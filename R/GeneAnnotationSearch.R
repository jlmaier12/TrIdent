...
#' }
GeneAnnotationSearch <- function(transductionclassification, phageread_dataset, gene_annots, geneorproduct, keywords, genelocation="nonspecific", bprange = 0, cleanup=TRUE, specificcontig) {
