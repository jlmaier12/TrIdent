...
#'@param windowsize The number of base pairs to average coverage values over. Options are 100, 200, 500, 1000 ONLY. Larger window sizes improve processing time but the resolution of read coverage patterns may be lost. Default is 1000 bp.
...
#'@param mincontiglength The minimum contig size (in bp) to perform pattern-matching on. Contigs smaller than this threshold will be filtered out. Default is 30,000 bp. Minimum size for prophage-like pattern-matching is 21,000 bp. Minimum size for Sloping pattern-matching is 45,000 bp.
