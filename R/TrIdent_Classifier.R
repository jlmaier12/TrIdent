...
#'
#'@examples \dontrun{
#'TrIdent_results <- TrIdent_Classifier(VLP_fracreadcov, whole_commreadcov, windowsize=1000, cleanup=TRUE)
#'}
  TrIdent_Classifier <- function(phageread_dataset, microbial_readdataset, windowsize = 1000, cleanup=TRUE){
  start_time <- Sys.time()
  ...
  SM_classifications_summary <- pattern_matcher(phageread_dataset, microbial_readdataset, windowsize)
