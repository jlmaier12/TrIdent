...
#'@param windowSize The number of bps to average coverage values over. Options are 100, 200, 500, 1000 ONLY. Larger windowSizes improve processing time but the resolution of read coverage patterns may be lost. Default is 1000 bp.
...
##error catching
  ...
  if(missing(SaveFilesTo) == FALSE){
    ...
    write.table(summaryTable, file=paste0(SaveFilesTo,"\\TrIdentOutput\\summary_table.csv"), sep=",", row.names=FALSE)
