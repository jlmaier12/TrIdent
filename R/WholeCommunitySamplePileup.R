...
#' is comprised of two parts-a whole-community fraction and a viral-like
#' particle (VLP)-fraction. This dataset represents the whole-community fraction
#' and was generated from a conventional mouse fecal homogenate. The
#' whole-community extracted DNA was sequenced with Illumina (paired-end mode,
#' 150 bp reads) after which the metagenome was assembled. The sequencing reads
#' were mapped to the assembled contigs using BBMap. The bbmap.sh bincov
#' parameter with covbinsize=100 was used to create a pileup file with 100 bp
#' windows. A subset of 10 contigs from the pileup file were selected for this
#' sample dataset. The contigs were chosen because their associated read
#' coverage patterns in the VLP-fraction exemplify TrIdent's pattern-matching
#' and characterization functionality across classifications:
